...
const LocaleTranslationData = {
	"en": {
		...
		"daily.patterns.create": "Create a Daily Pattern",
		"daily.patterns.edit": "Details/Edit Daily Pattern",
		...
		"help.admin.dailypatternview": "This page shows information on daily patterns. Please visit {link} for further details and information.",
